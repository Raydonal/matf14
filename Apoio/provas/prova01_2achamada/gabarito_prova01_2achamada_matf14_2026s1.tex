...
\begin{enumerate}
	...
	\begin{tabular}{c|cc}
	\hline
	Tipo de grão & Freq. absoluta & Fre. relativa \\
	\hline
	dentado & 5 & 50\% \\
	semidentado & 5 & 50\% \\
	\hline
...
\begin{enumerate}
	...
	$$
	S^2_H = \frac{3(10-15)^2 + 4(15-15)^2 + 3(20-15)^2}{10}
	= \frac{3 \cdot 25 + 3\cdot 25}{10}
	= \frac{150}{10} = 15.
	$$
	Logo o desvio padrão é $S_H = 3,873$. A variância do salário das mulheres é:
	$$
	S_M^2 = \frac{2 \cdot (5-10)^2 + 6 \cdot (10-10)^2 + 2 \cdot (15-10)^2}{10}
	= \frac{2 \cdot 25 + 2\cdot 25}{10}
	= \frac{100}{10} = 10.
	$$
	Logo o desvio padrão é $S_M = 3,1623$.
	}
	
	\item (1 ponto) Há indícios de diferença nos salários de homens e mulheres?\\
	{\color{blue}
	Os homens ganham em média 5 salários mínimos a mais que as mulheres. Os salários mediano e modal dos homens também são mais altos que os valores correspondentes para as mulheres. A variabilidade dos salários das mulheres é ligeiramente menor do que a variabilidade do salário dos homens, mas o valores são próximos. Podemos concluir que há indícios que os homens ganham salários significativamente maior do que o das mulheres.
	}
\end{enumerate}
...
\begin{enumerate}
	...
	{\color{blue} 
	Considere o evento $D = \{\text{peça sorteada é defeituosa}\}$. Então, pelo teorema da probabilidade total,
	\begin{align*}
	P(D) &= P(D|A)P(A) + P(D|B)P(B)  + P(D|C)P(C)\\
	&= 0,03*0,6 + 0,04*0,3 + 0,05*0,1\\
	&= 0,018 + 0,012 + 0,005 = 0,035.
	\end{align*}
	Logo, a probabilidade da peça não ser defeituosa é $P(D^c) = 0,965$.
	}
	
    \item (1 ponto) Qual é a probabilidade da peça ter sido produzida pela fábrica A ou B?\\
    {\color{blue}
    Como os eventos $A$ e $B$ são disjuntos,
    $$
    P(A \cup B) = P(A) + P(B) = 0,6 + 0,3 = 0,9.
    $$
    }
	...
	\begin{align*}
	P(A|D) = \frac{P(D|A) \cdot P(A)}{P(D)} = \frac{0,03*0,6}{0,035} = \frac{0,018}{0,035} = 0,5143.
	\end{align*}
	}
\end{enumerate}
