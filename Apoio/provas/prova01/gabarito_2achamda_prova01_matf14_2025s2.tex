...
\begin{flushleft}
	...
	MATF14 - Estatística Econômica I - 2025.2\\
...
\begin{center}
	\begin{Large}
		Segunda chamada da prova 1 {\color{blue} - GABARITO} \\
	\end{Large}	
%	Data: 14/05/2025
\end{center}
...
\begin{enumerate}
	...
	{\color{blue}
		$P(A \cap B) = P(A)P(B) = \frac{2}{3} \cdot \frac{3}{4} = \frac{1}{2}$.
	}
	
	\item (1 ponto) a pessoa $A$ resolver o problema e a pessoa $B$ não conseguir resolver o problema?\\
	{\color{blue}
		$P(A \cap B^c) = P(A) P(B^c) = \frac{2}{3} \cdot \frac{1}{4} = \frac{1}{6}$.
	}
...
\begin{enumerate}
	...
	{\color{blue}
	Os salários dos homens ordenado é: 10,10,10,15,15,15,15,20,20 e 20. O salário médio dos homens é $\frac{150}{10} = 15$. O salário mediano dos homens é $\frac{15 + 15}{2} = 15$. O salário modal dos homens é 15.
	
	Os salários das mulheres ordenado é: 5,5,10,10,10,10,10,10,15 e 15. O salário médio das mulheres é $\frac{100}{10} = 10$. O salário mediano das mulheres é $\frac{10 + 10}{2} = 10$. O salário modal das mulheres é 10.
	}
