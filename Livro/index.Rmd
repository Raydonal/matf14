...
date: "`r paste(as.integer(format(Sys.Date(), '%d')), 'de', c('janeiro','fevereiro','março','abril','maio','junho','julho','agosto','setembro','outubro','novembro','dezembro')[as.integer(format(Sys.Date(), '%m'))], 'de', format(Sys.Date(), '%Y'))`"
lang: pt-BR
...
exercícios **não valem nota**, mas são o principal instrumento de preparação; as resoluções são
discutidas em sala e não são publicadas neste material. Não há projetos nesta disciplina: o
...
|---|---|---|---|---|
| 1 | Estatística Descritiva e Exploratória de Dados | 1.1 – 1.7 | Aulas 01–08 | P1 |
| 2 | Introdução à Teoria das Probabilidades | 2.1 – 2.7 | Aulas 09–15 | P2 |
| 3 | Variáveis Aleatórias Discretas | 3.1 – 3.5 | Aulas 17–23 | P2 |
| 4 | Variáveis Aleatórias Contínuas | 4.1 – 4.4 | Aulas 24–30 | P3 |
| Apêndice A | Ferramentas de Trabalho: R e Python | - | apoio à Aula 02 e ao Cap. 1 | - |
| Apêndice B | Revisão de Cálculo (derivadas e integrais) | - | apoio ao Cap. 4 | - |
| Apêndice C | Fórmulário e tabelas de referência | - | consulta para as provas | - |
...
contextualizadas. O livro é a versão de referência mais completa: cada capítulo
...
- **Empresas e mercado financeiro**, faturamento, porte, setor, retorno de ações, incluindo
  `empresas.csv`, base **real** de 106 empresas brasileiras (porte, faturamento, setor, região),
...
@dantas1997probabilidade, @hoggmckeancraig2013 e @triola2007introducao. Fontes de dados e
referências oficiais citadas ao longo do texto: @ibge2024pnad, @bacen2024ipca e
@wooldridge2016introducao.
