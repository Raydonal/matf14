...
(R$ `r format(round(resumo_faturamento$media,0), big.mark=".")` mil) fica bem acima da mediana
(R$ `r format(round(resumo_faturamento$mediana,0), big.mark=".")` mil). Isso é a assinatura de uma
