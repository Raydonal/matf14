...
hist(empresas$faturamento99,
     ...
     xlab = "Faturamento 1999", ylab = "Frequência", col = "#c9971e")
```

```python
plt.hist(empresas["faturamento99"], color="#c9971e")
plt.title("Histograma do faturamento (1999)")
plt.xlabel("Faturamento 1999"); plt.ylabel("Frequência")
plt.show()
```
...
```{r grafico-barras-base, fig.height=3.6}
par(mar = c(4, 13, 3, 1))              # margem esquerda larga para os nomes
barplot(sort(setor_freq), horiz = TRUE, las = 1,
        main = "Empresas por setor (barras)",
        xlab = "Número de empresas", col = "#0d3b54")
```

```python
setor_freq.sort_values().plot(kind="barh", color="#0d3b54")
