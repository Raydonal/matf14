...
```{r fig-fda-exercicio, echo=FALSE, out.width="55%"}
...
**4.** A partir só desse gráfico (sem nenhuma tabela de \(p(x)\)), como você recuperaria \(p(x_i)\)
para cada \(x_i\)? Escreva a fórmula geral usando a diferença de dois valores de \(F\), e confira
aplicando-a aos saltos que você acabou de ler.
