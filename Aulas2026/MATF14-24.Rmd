...
$$
P(5\le X\le 15) = \int_5^{15} 0{,}2\,e^{-0{,}2x}\,dx
$$
...
**2.** Compare com o caso discreto: lá, \(\sum_i p(x_i)=1\) com uma soma de (possivelmente) infinitos
